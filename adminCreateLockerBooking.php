...
//the bellow code inserts the needed info into the waitinglistparents table c
    ...
    echo "Placed student on waiting list successfully<br>";
...
$row3 = $stmt3->fetch(PDO::FETCH_ASSOC);
 ...
 THE INFO TO SEND AN EMAIL IS HERE  below here-- */
  try {
    ...
    $mail->send();
    echo 'Email Message Sent to Parent <br>';
    echo $parentEmail . "<br>";
        echo 'Email Message Sent to Admin <br>';
    echo $adminEmail . "<br>";
    echo "<br>";
    echo "<br>";
...
//If all is a success the next line automatically takes the USER BACK TO the bookingManagementPage
     echo "<h3><button class='label' onclick=\"window.location.href='adminBookingManagementPage.php?StudentNumber=$studentNumberToCarry'\">Click to manage this booking</button></h3>";
 ...
 echo "<h3><button class='label' onclick=\"window.location.href='adminBookingManagementPage.php?StudentNumber=$studentNumberToCarry'\">Back To Admin Booking Management</button></h3>";
?>
</div>
</div>