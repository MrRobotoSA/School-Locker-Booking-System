...
$ParentIdNumber = $rowStudent['ParentIdNumber'];
...
echo "</div>";
    ...
    echo "<h3><button class='label' onclick=\"window.location.href='adminBookingManagementPage.php?StudentNumber=$studentNumberToCarry'\">Manage and Create Locker Booking</button></h3>";
}
//---------------------------------------------------------------------------------------------------------------------------
//The echo below is just for the button to go back to adminOneParentDashboard
echo "<br>";
 echo "<h3><button class='label' onclick=\"window.location.href='adminOneParentDashboard.php?ParentIdNumber=$ParentIdNumber'\">Back to Admin One Parent Dashboard</button>";
}
else {
