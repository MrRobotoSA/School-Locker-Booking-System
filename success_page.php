...
<?php
session_start();
 $ParentIdNumber = isset($_SESSION['ParentIdNumber']) ? $_SESSION['ParentIdNumber'] : '';
?>
...
<!-- Below you can see the button container, this class="button-container is making all the buttons center and under eachother r-->
<div class="button-container">

<!-- Navigation Button to go to the parent login page section for the website r-->
