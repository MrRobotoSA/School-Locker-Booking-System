...
if ($rowCount) {
    ...
    echo "<button class='label' onclick=\"window.location.href='adminStudentDashboard.php?StudentNumber=$studentNumberToCarry'\">Manage and Create Bookings</button>";
    echo "<br><br>";
    }
...
echo "<button class='label' onclick=\"window.location.href='adminCreateStudentChildValidation.php?ParentIdNumber=$ParentIdNumber'\">Add a Valid Student/child</button>";
echo "<br>";
echo "<br>";
// the below line of code is the button that takes a parent to the page where a student account can be created c
//echo "<button class='label' onclick=\"window.location.href='adminCreateStudentChild.php?ParentIdNumber=$ParentIdNumber'\">Add an UNVALIDATED student/child</button>";
echo "<br>";
echo "<br>";
// The below button takes you back to the Index page of the website
echo "<button class='label' onclick=\"window.location.href='adminParentDashboard.php'\">Back to Admin All Parents Page</button>";
echo "<br>";
echo "<br>";
echo "<button class='label' onclick=\"window.location.href='adminDashboard.php'\">Go back to Admin Dashboard</button>";
// The below button takes you back to the Index page of the website
echo "<br>";
echo "<br>";
