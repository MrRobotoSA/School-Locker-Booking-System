...
while ($row1 = $stmt1->fetch(PDO::FETCH_ASSOC)) {
    ...
    //The bellow two lines of code are vital to carry the correct childs details over to the delete booking page
        ...
        echo "<h3><button class='label' onclick=\"window.location.href='adminDeleteBookingPage.php?StudentNumber=$studentNumberToCarry'\">Delete Booking</button></h3>";
        echo "<br><br>";
    }
    else {
...
$ParentIdNumberToCarry = $rowStudent['ParentIdNumber'];
echo "<h3><button class='label' onclick=\"window.location.href='adminCreateLockerBooking.php?StudentNumber=$studentNumberToCarry&ParentIdNumber=$ParentIdNumberToCarry'\">Create a booking for this student</button></h3>";
echo "<br>";
echo "<br>";
echo "<br>";
 ...
 echo "<h3><button class='label' onclick=\"window.location.href='adminStudentDashboard.php?StudentNumber=$studentNumberToCarry'\">Go Back To Student Dashboard</button></h3>";
}
else {
